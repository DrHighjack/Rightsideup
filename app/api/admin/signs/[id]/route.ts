        ...
        try {
          await sendEmail({
            ...
            html: `
              ...
              <p>The inventory for <strong>${signType}</strong> signs has dropped below the threshold.</p>
              <ul>
                <li><strong>Sign Type:</strong> ${signType}</li>
                <li><strong>Available Count:</strong> ${availableCount}</li>
                <li><strong>Threshold:</strong> ${LOW_INVENTORY_THRESHOLD}</li>
              </ul>
              <p>Please consider ordering more signs of this type.</p>
            `,
