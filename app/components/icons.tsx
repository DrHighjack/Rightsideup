// Minimal inline SVG icon set (Heroicons-style 24px outlines).
// Inlined rather than pulled from a package so the nav stays dependency-free.
...
export const SignpostIcon = ({ className }: IconProps) => (
  <svg {...base(className)}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m0-18h6.75l2.25 2.625-2.25 2.625H12m0 3h-6.75L3 13.875 5.25 16.5H12M9 21h6" />
  </svg>
);
