...
export async function sendEmail(options: EmailOptions) {
  try {
    const {
      ...
      html,
      text,
      from = process.env.SENDGRID_FROM_EMAIL || "noreply@northshoresignco.com",
    } = options;
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background-color: #f9fafb; padding: 15px; border-radius: 4px; margin: 15px 0;">
        <div style="margin: 10px 0; padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
          <span style="font-weight: 600; color: #1a6640; display: inline-block; min-width: 120px;">Order #:</span>
          <span style="color: #555;">${orderNumber}</span>
        </div>
        <div style="margin: 10px 0; padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
          <span style="font-weight: 600; color: #1a6640; display: inline-block; min-width: 120px;">Type:</span>
          <span style="color: #555;">${orderDetails.type}</span>
        </div>
        <div style="margin: 10px 0; padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
          <span style="font-weight: 600; color: #1a6640; display: inline-block; min-width: 120px;">Address:</span>
          <span style="color: #555;">${orderDetails.address}</span>
        </div>
        ${
          scheduledDateStr
            ? `
        <div style="margin: 10px 0; padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
          <span style="font-weight: 600; color: #1a6640; display: inline-block; min-width: 120px;">Scheduled:</span>
          <span style="color: #555;">${scheduledDateStr}</span>
        </div>
        `
            : ""
        }
      ...
      <p style="color: #999; font-size: 12px;">
        © 2026 North Shore Sign Co. All rights reserved.
      </p>
    </div>
  `;
